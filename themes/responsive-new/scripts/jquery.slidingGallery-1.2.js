...
(function($) {
    ...
    $.galleryUtility.Options = {
        ...
        zoomSpeed: 'fast',
        gutterWidth: -30,
        captionUpPath: '/sudan/wp-content/themes/responsive/Images/SlidingGallery/captionUpArrow.png',
        captionUpWidth: 24,
        captionUpHeight: 17,
        captionUpID: 'captionArrowUp',
        captionDownPath: '/sudan/wp-content/themes/responsive/Images/SlidingGallery/captionDownArrow.png',
        captionDownWidth: 24,
    ...
    $.fn.slidingGallery = function(options) {
        ...
        $.galleryUtility.centerImage.image.css('z-index', '3');
        $.galleryUtility.leftImage.image.css('z-index', '2');
        $.galleryUtility.rightImage.image.css('z-index', '2');
