...
(function (jQuery)
{
	jQuery.fn.iframePostForm = function (options)
	{
		...
		{
			jQuery('body').append('<iframe id="' + options.iframeID + '" name="' + options.iframeID + '" style="display:none" />');
		}
		...
		return jQuery(this).each(function ()
		{
			...
			element.submit(function ()
			{
				...
				iframe = jQuery('#' + options.iframeID).load(function ()
				{
					...
					if (options.json)
					{
						returnReponse = jQuery.parseJSON(response.html());
					}
